            ...
            <div className="form-group form-group--resolution">
              ...
              <div className="resolution-select" ref={resolutionMenuRef}>
                <button
                  ...
                  onClick={() => {
                    if (!isResolutionMenuOpen && resolutionTriggerRef.current) {
                      ...
                      // Estimar altura do menu: 4 opções * 44px + padding ≈ 190px
                      const menuEstimatedHeight = 190;
                      setDropdownDirection(spaceBelow < menuEstimatedHeight ? 'up' : 'down');
                    }
                ...
                {isResolutionMenuOpen ? (
                  <div className={`resolution-select__menu${dropdownDirection === 'up' ? ' resolution-select__menu--up' : ''}`}>
