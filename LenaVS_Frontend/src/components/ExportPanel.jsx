...
const ExportPanel = ({
  ...
  // Confirmação antes de descartar o projeto atual e abrir um novo em branco
  const handleCreateNewProject = () => {
    const confirmed = window.confirm(
      'Deseja criar um novo projeto?\n\nO projeto atual será descartado do editor. Certifique-se de ter exportado ou salvo o que precisava antes de continuar.'
    );
    if (confirmed) {
      onCreateNewProject?.();
    }
