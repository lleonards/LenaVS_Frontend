...
const ExportPanel = ({
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const fallbackFileName = response.data?.downloadFileName || `${exactProjectName}.${videoFormat}`;
      ...
      const finalFileName = response.data?.downloadFileName || fileNameFromHeader || fallbackFileName;
