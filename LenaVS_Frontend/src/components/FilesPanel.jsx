    ...
    <div className="files-panel" ref={panelRef}>
      ...
      {hasBackgroundMedia ? (
        <div className={`files-animation-wrapper${showAnimationsPanel ? ' is-open' : ''}`}>
          ...
          {showAnimationsPanel ? (
            <div className="files-animation-overlay" role="dialog" aria-label="Painel de animações de mídia">
              <div className="files-animation-popover files-animation-popover--overlay">
                <div className="files-animation-popover__header">
                  <div>
                    <strong>Animações de mídia</strong>
                    <p>
                      Ajuste a entrada e a saída da mídia. No desktop este painel agora abre por cima de Arquivos, igual ao comportamento compacto do mobile.
                    </p>
                  </div>
