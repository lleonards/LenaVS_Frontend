...
const FilesPanel = ({
  ...
  // ─── FIX: instrumental agora é OPCIONAL para sincronização ───────
  // Só precisa de: Música Original + Letra (arquivo ou manual)
        ...
        <div className="auto-sync-hint">
          {isSyncing
            ...
            ? uploaded.musicaInstrumental
              ? 'Sincroniza usando Whisper + isolamento vocal (instrumental detectado)'
              : 'Sincroniza os tempos usando Whisper AI — instrumental é opcional'
            : lockMessage}
        </div>
      </div>
