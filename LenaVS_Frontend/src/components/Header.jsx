          ...
          <div className="profile-modal" onClick={(event) => event.stopPropagation()}>
            ...
            {profileModalStep === 'edit' ? (
              <form className="profile-modal__body" onSubmit={handleSaveProfile}>
                ...
                <section className="profile-modal__danger-zone profile-modal__danger-zone--compact">
                  <div>
                    <strong>Excluir conta</strong>
                    <p className="profile-modal__danger-note">Remova sua conta de forma permanente, com cancelamento da assinatura e tratamento dos seus projetos conforme a política da LenaVS.</p>
                  </div>
                </section>
