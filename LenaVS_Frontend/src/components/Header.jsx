...
const getProfileButtonLabel = (displayName, userEmail) => {
  const resolvedName = getDisplayName(displayName, userEmail);
  return getInitials(resolvedName);
};
...
const Header = ({ onOpenProjects = () => {} }) => {
  ...
  const profileButtonLabel = useMemo(
    () => getProfileButtonLabel(displayName, userEmail),
    [displayName, userEmail]
  );
          ...
          <div className="header-profile-wrap" ref={profileMenuRef}>
            ...
            >
              ...
              <span className="header-profile-button__text">
                <span className="header-profile-button__name">{profileButtonLabel}</span>
              </span>
            </button>
