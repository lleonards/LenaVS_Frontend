...
const GUIDE_INTRO_PARAGRAPHS = [
  'A LenaVS é uma ferramenta para criar vídeos de karaokê de forma simples, onde você usa a música original para marcar o tempo de cada parte da letra e depois visualiza tudo com a versão instrumental.',
];
