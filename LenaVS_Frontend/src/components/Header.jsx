              ...
              <form className="profile-modal__body" onSubmit={handleSaveProfile}>
                ...
                <section className="profile-modal__danger-zone">
                  <div>
                    ...
                    <p>Remova sua conta de forma permanente, com cancelamento da assinatura e tratamento dos seus projetos conforme a política da LenaVS.</p>
                  </div>

                  <button
                    type="button"
                    className="profile-modal__danger-cta"
