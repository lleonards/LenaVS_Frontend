...
const GUIDE_STEPS = [
  ...
  'Cada exportação consome 1 crédito apenas no plano free. No plano upgrade, o uso fica liberado enquanto o acesso estiver ativo.',
];
    ...
    <>
      <header className="header">
        ...
        <div className="header-center-slot" aria-live="polite">
          {showFreeLimitNotice ? (
            <button type="button" className="header-free-limit-notice" onClick={handleUpgrade}>
              <AlertTriangle size={15} />
              <span>Limite gratuito atingido. Ative o LenaVS Upgrade.</span>
            </button>
          ) : null}
        </div>
