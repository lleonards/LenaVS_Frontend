...
import { createStanzaFromText, duplicateStanza, isStanzaActiveAtTime } from '../utils/stanza';
        ...
        {stanzas.map((stanza, idx) => {
          ...
          return (
            ...
            >
              ...
              <div className="lep-position-hint">
                💡 Selecione a estrofe e arraste no preview para definir a posição visual.
              </div>
