...
const LyricsEditorPanel = ({ stanzas, onStanzasChange, currentTime, onTapSync }) => {
  ...
  const formatCurrentTime = (sec) => formatTimecode(sec);
        ...
        {stanzas.map((stanza, idx) => {
          ...
          return (
            <div key={stanza.id} className={`lep-block${active ? ' lep-block-active' : ''}`}>
                  ...
                  <div className="lep-time-input-group">
                    <input
                      ...
                      onBlur={(e) => {
                        ...
                        updateStanza(stanza.id, 'startTime', parsed === null ? DEFAULT_TIMECODE : formatTimecode(parsed));
                      }}
                      placeholder="mm:ss"
                    />
                    <button
                    ...
                    >
                      <span className="lep-tap-icon" aria-hidden="true">
                        {/* Ícone simples de "mira" (target/crosshair) */}
                ...
                <div className="lep-field">
                  ...
                  <div className="lep-time-input-group">
                    <input
                      ...
                      onBlur={(e) => {
                        const parsed = parseTimecode(e.target.value);
                        updateStanza(stanza.id, 'endTime', parsed === null ? DEFAULT_TIMECODE : formatTimecode(parsed));
                      }}
                      placeholder="mm:ss"
                    />
                    <button
              ...
              {/* Sincronização por linha removida do painel do editor */}
