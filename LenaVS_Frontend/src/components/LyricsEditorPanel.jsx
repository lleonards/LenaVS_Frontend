        ...
        {stanzas.map((stanza, idx) => {
          ...
          return (
            <div
              ...
              tabIndex={0}
              onPointerDownCapture={() => onStanzaSelect?.(stanza.id)}
              onFocusCapture={() => onStanzaSelect?.(stanza.id)}
            >
                ...
                <div className="lep-field lep-field-time">
                  ...
                  <div className="lep-time-input-group">
                    ...
                    <button
                      ...
                      title={`Marcar início agora (${formatCurrentTime(currentTime)}) • Atalho M`}
                    >
                ...
                <div className="lep-field lep-field-time">
                  ...
                  <div className="lep-time-input-group">
                    ...
                    <button
                      ...
                      title={`Marcar fim agora (${formatCurrentTime(currentTime)}) • Atalho N`}
                    >
                      <span className="lep-tap-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <circle cx="12" cy="12" r="7" stroke="currentColor" strokeWidth="2" />
