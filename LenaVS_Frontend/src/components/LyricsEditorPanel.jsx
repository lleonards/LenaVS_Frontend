    ...
    <div className="lyrics-editor-panel">
      ...
      <div className="lep-list">
        {stanzas.map((stanza, idx) => {
          ...
          const isLastBlock = idx === stanzas.length - 1;
          ...
          return (
            ...
            >
              ...
              <div className="lep-outline-inline">
                <span className="lep-outline-inline__label">Contorno</span>
                <span className="lep-outline-inline__edge">fino</span>
                <input
                  className="lep-slider lep-slider--minimal lep-slider--compact"
                  type="range"
                ...
                />
                <span className="lep-outline-inline__edge">forte</span>
                <span className="lep-outline-inline__value">{safeOutlineWidth}px</span>
              </div>
              ...
              {isLastBlock && (
                <div className="lep-transition-panel">
                  <div className="lep-transition-panel-head">
                    <span className="lep-transition-title">Transição final</span>
                  ...
                  <div className="lep-transition-row">
                    ...
                    <div className="lep-transition-control lep-transition-control-slider">
                      ...
                      <input
                        className="lep-slider lep-slider--compact"
                        type="range"
                        min={STANZA_TRANSITION_DURATION_MIN}
                        max={STANZA_TRANSITION_DURATION_MAX}
                        step="0.1"
