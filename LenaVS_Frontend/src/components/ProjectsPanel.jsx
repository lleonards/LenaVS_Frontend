        ...
        {activeTab === 'history' ? (
          <div className="projects-section">
            <div className="projects-section__toolbar">
              <span>Gerencie seus projetos privados e escolha quais deseja compartilhar na Biblioteca LenaVS.</span>
            ...
            <div className="projects-incentive-notice">
              Seus projetos privados ficam disponíveis apenas para você. Publique os melhores trabalhos na Biblioteca LenaVS e ajude outros usuários.
            </div>
