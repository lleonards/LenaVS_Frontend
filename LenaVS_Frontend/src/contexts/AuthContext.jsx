...
export const AuthProvider = ({ children }) => {
    ...
    try {
      ...
      try {
        ...
        if (backendResponse?.data) {
          return applyUserSnapshot(backendResponse.data);
        }
      } catch (backendError) {
  ...
  const signUp = async (email, password, name, countryCode = 'BR') => {
