...
const Upgrade = () => {
  ...
  const handleCheckout = async (option) => {
    try {
      ...
      const payload = option.provider === 'sellx'
        ? { provider: 'sellx', currency: 'brl' }
    ...
    <div className="upgrade-container">
      <div className="upgrade-shell">
        ...
        <div className="upgrade-note">
          Se você está no Brasil, use o <strong>SellX</strong>. Se está fora do Brasil, a opção mais indicada é o <strong>Stripe</strong>.
        </div>
